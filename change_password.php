      ...
      <div class="card-body">
        <form method="post" action="change_password_code.php">
          ...
          <div class="form-group">
              ...
              <input class="form-control" id="exampleInputPassword1" type="password" placeholder="Enter Your Current Password" name="txt_current_pass">
              </div><br>
              
              <div class="form-row">
              <label for="exampleInputPassword2">Enter Your New Password</label>
              <input class="form-control" id="exampleInputPassword2" type="password" placeholder="Enter Your New Password" name="txt_new_pass">
              </div><br>
              
              <div class="form-row">
              <label for="exampleInputPassword3">Enter Confirm Password</label>
              <input class="form-control" id="exampleInputPassword3" type="password" placeholder="Enter Confirm Password" name="txt_confirm_pass">
              </div><br>
