...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card-header">Register an Account For Expert</div>
      <div class="card-body">
        <form method="post" action="expert/add_expert_code.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="exampleInputEmail7">Qualification</label>
            <input class="form-control" id="exampleInputEmail7" type="text" aria-describedby="emailHelp" placeholder="Enter Qualification" name="txt_qua">
          </div>

          <div class="form-group">
            <label for="exampleInputEmail2">Image</label>
            <input class="form-control" id="exampleInputEmail2" type="file" aria-describedby="emailHelp" name="txt_img">
          </div>

          <input type="submit" class="btn btn-primary btn-block" name="btn_addexpert" value="Register">
        </form>
      </div>
    </div>
          </div>
