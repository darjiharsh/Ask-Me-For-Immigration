    ...
    <div class="container-fluid">
      <div class="row">
          ...
          ?>
            ...
            $cnt=0;
            $qry4 = "SELECT * FROM que_like WHERE p_id='". $post_id ."'";
            ...
            ?>
                <div class="page-content ask-question" style="height: auto;">
                  ...
                  <?php
                    ...
                    $qry3 = "SELECT * FROM post_tbl WHERE pid='". $post_id ."' ";
                    $rs3 = mysqli_query($conn,$qry3);
                      if(mysqli_num_rows($rs3) > 0)
                      {
                        while($row3 = mysqli_fetch_assoc($rs3))
                        {
                            ...
                            $desc=$row3['post_desc'];
                            $key=$row3['post_keyword'];
                            $cat=$row3['post_cat_id'];
                        }
                      }

                    $qry6 = "SELECT * FROM cate_tbl WHERE cid='". $cat ."' ";
                    ...
                    <tr>
                      <td style="width:250px;"><h5>Post Title</h5></td>
                      <td><?php echo ":&nbsp&nbsp&nbsp".$title; ?></td>
                    </tr>

                    <tr>
                      <td><h5>Post Description</h5></td>
                    ...
                    <tr>
                      <td><h5>Post Keyword</h5></td>
                      <td><?php echo ":&nbsp&nbsp&nbsp".$key; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td><a href="ans_like.php"><input type="button" name="btn_like" class="btn btn-info" value="Like <?php echo $cnt; ?>"></a></td>
                    </tr>
                  </table><hr><br>

                    <?php
                    $qry1 = "SELECT * FROM comment_tbl WHERE post_id='". $post_id ."' ";
                  ...
                  <form method="post" action="view_post_cmmt_code.php?post_id=<?php echo $post_id; ?> && user_id=<?php echo $user_id; ?> && user_type=<?php echo $user_type; ?>">
