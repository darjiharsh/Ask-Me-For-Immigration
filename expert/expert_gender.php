  ...
  <div class="content-wrapper">
    <div class="container-fluid">
          ...
          ?>
                ...
                <form method="post" action="expert_gender_code.php">
                <center>
                ...
                <textarea class="form-control" type="text" name="txt_add" style="width:400px;" pattern="[A-Za-z ]{1,15}" title="Enter Proper Answer" required></textarea><br>

                
                <label for="exampleInputName"><b>Select Your Gender</b></label><br>
                <input type="radio" name="r1" value="male" required>Male&nbsp&nbsp&nbsp
                <input type="radio" name="r1" value="female" required>Female<br><br>
          ...
          <h4><center><a href="expert_country.php">Next</a></center></h4>
