          ...
          ?>
            ...
            ?>
                <div class="page-content ask-question" style="height: auto;">
                  ...
                  <?php
                  $qry3 = "SELECT * FROM comment_tbl WHERE id='". $cmmt_id ."' ";
                  ...
                  <label><h4>Comment : </h4><div class="com" style="width: 80%; height: auto; margin-left: 125px; margin-top: -29px;"><?php echo $comment; ?></div></label>

                  <hr><br>

                    <?php
                    $qry1 = "SELECT * FROM reply_tbl WHERE cmmt_id='". $cmmt_id ."' ";
                    $rs1 = mysqli_query($conn,$qry1);
                      if(mysqli_num_rows($rs1) > 0)
                      {
                        while($row1 = mysqli_fetch_assoc($rs1))
                        {
                            ...
                            echo '<b style="margin-left:90px;">Reply - </b> <div class="com" style="width:80%; height:auto; margin-left:90px;" >'.$reply.'</div><br>';
                      ?>
                  ...
                  <form method="post" action="view_que_cmmt_reply_code.php?cmmt_id=<?php echo $cmmt_id; ?> && user_id=<?php echo $user_id; ?> && user_type=<?php echo $user_type; ?>">
                    
                    <div class="input-group">
                      <input type="text" class="form-control" name="txt_reply" placeholder="Write Your Answer" aria-describedby="basic-addon2">
