  ...
  <div class="content-wrapper">
    <div class="container-fluid">
          ...
          <div class="card-body">
            ...
            <img src="<?php echo $path.$img ?>" style="width:100px;height:100px;"><br>
                                      ...
                                      while($row4 = mysqli_fetch_assoc($rs4))
                                        ...
                                        <form class="input-group" method="post" action="cmmt_code1.php?to_id=<?php echo $mail1; ?> && qid=<?php echo $row3['id']; ?>">
                                          <table>
                                            <tr>
                                              <td>
                                                <input type="text" name="txt_cmmt" class="form-control" style="width:500px;" placeholder="Enter Your Answer">
                                              </td>
                                              <td>
